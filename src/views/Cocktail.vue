    ...
    <div class="container my-16 mx-auto px-8">
      <div class="flex items-center justify-between mb-8">
        <input
          ...
          class="bg-white focus:outline-none focus:shadow-outline border border-gray-400 rounded-lg py-2 px-4 block w-full appearance-none leading-normal mr-4"
          type="search"
      ...
      <div class="mb-16">
        <h1 class="text-2xl font-bold my-6">{{ $t("cocktailRecs") }}</h1>
        <div
        ...
        <div v-else>{{ $t("loadingRecs") }}</div>
      </div>
      <h1 class="text-2xl font-bold mb-6">{{ $t("cocktailReci") }}</h1>
      <div
